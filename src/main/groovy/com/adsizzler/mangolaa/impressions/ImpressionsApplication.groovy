package com.adsizzler.mangolaa.impressions

import com.adsizzler.mangolaa.impressions.verticle.ImpressionAndBillingVerticle
...
class ImpressionsApplication {
	...
	static void main(String[] args) {
		SpringApplication.run ImpressionsApplication, args
	}
	...
	void deployVerticles(){
		...
		vertx.deployVerticle(springVerticleFactory.prefix() + ":" + ImpressionAndBillingVerticle.class.name ,options,{ deployment->
